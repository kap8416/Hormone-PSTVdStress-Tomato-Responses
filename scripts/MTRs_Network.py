...
OUT_PNG = "MTRs_Network_v7.png"
OUT_SVG = "MTRs_Network_v7.svg"
...
for b, full in MTRS_BASE.items():
    meta = MTRS[full]
    G.add_node(b, kind="MTR", label="", fill=meta["fill"],
...
nx.draw_networkx_nodes(G, pos, nodelist=[t for t in shared_targets if base_id(t) not in special_nodes],
                       node_color=[COMBO_COLORS.get(combo_per_target.get(t, ""), "#000000")
                                   for t in shared_targets if base_id(t) not in special_nodes],
...
# Legend
legend_elements = [
    Line2D([0], [0], marker='o', color='w', label='Unique target', markerfacecolor=TARGET_GREY, markersize=6),
    Line2D([0], [0], marker='o', color='w', label='Shared EJ', markerfacecolor=COMBO_COLORS["EJ"], markersize=6),
    Line2D([0], [0], marker='o', color='w', label='Shared EA', markerfacecolor=COMBO_COLORS["EA"], markersize=6),
    Line2D([0], [0], marker='o', color='w', label='Shared AJ', markerfacecolor=COMBO_COLORS["AJ"], markersize=6),
    Line2D([0], [0], marker='o', color='w', label='Shared AEJ', markerfacecolor=COMBO_COLORS["AEJ"], markersize=8),
]
